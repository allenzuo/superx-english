...
async function loadTypes() {
  ...
  const innovationCounts = await readingPracticeService.getCounts()
  
  const innovation = [
    { id: 'reading_new', count: innovationCounts.reading || 0 },
    { id: 'cloze_new', count: innovationCounts.cloze || 0 },
    { id: 'reading_qa', count: innovationCounts.reading_qa || 0 },
    { id: 'multimodal', count: innovationCounts.multimodal || 0 },
    { id: 'writing', count: innovationCounts.writing || 0 }
  ]
...
function startPractice(typeId: string) {
  const urlMap: Record<string, string> = {
    ...
    'reading_new': '/pages/reading/practice?type=reading',
    'cloze_new': '/pages/reading/practice?type=cloze',
    'reading_qa': '/pages/reading/practice?type=reading_qa',
    'multimodal': '/pages/reading/practice?type=multimodal',
    'writing': '/pages/reading/practice?type=writing'
  }
